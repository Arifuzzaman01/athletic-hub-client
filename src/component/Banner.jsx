...
const eventPromise = fetch(`${import.meta.env.VITE_base_url}/athletic`).then(
  (res) => res.json()
);

const Banner = () => {
  const initialEvent = use(eventPromise);
  // console.log(initialEvent);
  initialEvent.sort((a, b) => {
                ...
                <div className="hero-content text-neutral-content text-center">
                  <div className="">
                    ...
                    >
                      ...
                      showcase their reach, flexibility, and control. Whether
                      it's a standing reach, vertical extension, or dynamic
                      leap, this category highlights the explosive power and
                      precision of each participant. It's not just about how far
                      you can go — it’s about how accurately and consistently
                      you can get there..
                    </motion.p>
                    <Link
                      to="/all-events"
